...
public class EvaluacionesActivity extends AppCompatActivity
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.evaluaciones, menu);
        return true;
    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_asignaturas) {
            Toast.makeText(EvaluacionesActivity.this, "Asignaturas", Toast.LENGTH_SHORT).show();
            intent = new Intent(this, AsignaturasActivity.class);

        } else if (id == R.id.nav_evaluaciones) {
            Toast.makeText(EvaluacionesActivity.this, "Evaluaciones", Toast.LENGTH_SHORT).show();
            intent = new Intent(this, EvaluacionesActivity.class);

        } else if (id == R.id.nav_rubricas) {
            Toast.makeText(EvaluacionesActivity.this, "Rubricas", Toast.LENGTH_SHORT).show();
            intent = new Intent(this, RubricasActivity.class);

        }/* else if (id == R.id.nav_sign_out) {
            Toast.makeText(EvaluacionesActivity.this, "Sign out", Toast.LENGTH_SHORT).show();
        }*/
