...
public class RubricasActivity extends AppCompatActivity
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.rubricas, menu);
        return true;
    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_asignaturas) {
            Toast.makeText(RubricasActivity.this, "Asignaturas", Toast.LENGTH_SHORT).show();
            intent = new Intent(this, AsignaturasActivity.class);

        } else if (id == R.id.nav_evaluaciones) {
            Toast.makeText(RubricasActivity.this, "Evaluaciones", Toast.LENGTH_SHORT).show();
            intent = new Intent(this, EvaluacionesActivity.class);

        } else if (id == R.id.nav_rubricas) {
            Toast.makeText(RubricasActivity.this, "Rubricas", Toast.LENGTH_SHORT).show();
            intent = new Intent(this, RubricasActivity.class);

        } else if (id == R.id.nav_sign_out) {
            Toast.makeText(RubricasActivity.this, "Sign out", Toast.LENGTH_SHORT).show();
